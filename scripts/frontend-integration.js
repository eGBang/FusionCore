 ...
 * This file demonstrates how to integrate Fusioncore with a web frontend
 */

// For React/Vue/Angular applications
export class FusioncoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FusioncoreClient(provider, contractAddress);
